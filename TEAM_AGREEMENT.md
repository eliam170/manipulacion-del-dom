...
* **Reuniones de Sincronización (Daily Stand-up):** Nos reuniremos los días [Días de la semana] a las [no hubo reunion] de forma [Presencial/Virtual].
...
* **Regla del Bloqueo (Timeboxing):** Si un desarrollador lleva más de [ 4 horas] atascado en el mismo error, **debe** levantar la mano y pedir ayuda al equipo. No se permite perder días enteros en silencio.
